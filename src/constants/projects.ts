  ...
  personal: [
    {
      ...
      description:
        "Ecossistema de to-do list em monorepo composto por três microsserviços Spring Boot integrados por Spring Cloud: um service-main que atua como Config Server e Eureka Server, um service.one responsável pelo CRUD de tarefas e um service.notification que processa alertas via OpenFeign. O projeto elimina IPs hardcoded, externaliza configurações em um repositório Git e demonstra descoberta dinâmica de serviços, comunicação declarativa e tolerância a falhas em uma arquitetura distribuída pronta para evoluir em escala.",
      technologies: [
        "Java 17/21",
        "Spring Boot 4.1",
      ...
      highlights: [
        ...
        "Descoberta dinâmica de serviços com Netflix Eureka",
        "Comunicação declarativa entre microsserviços com OpenFeign",
        "Persistência com Spring Data JPA e H2 para o serviço de tarefas",
        "Eliminação de IPs hardcoded e configurações por ambiente no código",
        "Fluxo de execução documentado com inicialização ordenada dos serviços",
        "Isolamento de responsabilidades para facilitar escala e manutenção",
      ],
      featured: true,
      links: {
        github:
          "https://github.com/GabrielF0900/todo-list-spring-cloud-microservices",
        case_study: null,
      },
    },
    {
