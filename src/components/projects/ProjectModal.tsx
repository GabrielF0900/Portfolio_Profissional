...
export default function ProjectModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-6xl max-h-[75vh] overflow-hidden p-0 flex flex-col">
        {" "}
        {/* Close button */}
        <button
        ...
        {/* Content - Scrollable */}
        <div className="flex-1 overflow-y-auto min-h-0 p-3 sm:p-4 space-y-2">
          {/* Imagem - Pequena no topo */}
          {project.image && (
            <div className="h-[2px] w-[1%] aspect-square overflow-hidden rounded-lg bg-muted">
              <img
                src={project.image}
                alt={project.title}
