            ...
            <Card key={cert.id} className="overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-gray-600 mb-3">{cert.issuer}</p>
                  <Badge className={cert.status === "Certificado" ? "bg-green-600" : "bg-orange-500"}>
                    {cert.status}
                  </Badge>
                  {cert.date && <p className="text-xs text-gray-500 mt-2">{cert.date}</p>}
                </div>
              </CardContent>
            </Card>
          ))}
