                ...
                <CardHeader>
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                    ...
                    <div className="flex flex-col md:items-end">
                      ...
                      <span className="text-sm text-muted-foreground mt-1">7 meses</span>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1 text-sm text-muted-foreground">
                        ...
                        <li className="flex items-start gap-2">
                          <div className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                          <span>Estabelecimento de cultura de desenvolvimento ágil e qualidade de código melhorando então a capacidade de pensamento dos membros</span>
                        </li>
                      </ul>
                    </div>
