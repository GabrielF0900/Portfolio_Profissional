...
export default function Footer() {
  ...
  return (
    <footer className="py-12 bg-white dark:bg-slate-950 text-slate-700 dark:text-slate-50">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 pb-8 border-b border-slate-200 dark:border-slate-700">
            <div className="bg-gradient-to-r from-slate-100 to-slate-50 dark:from-slate-800 dark:to-slate-900 rounded-xl p-4 flex items-center gap-4 hover:from-slate-200 hover:to-slate-100 dark:hover:from-slate-700 dark:hover:to-slate-800 transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-xs font-semibold text-slate-600 dark:text-slate-100 uppercase tracking-wider">
                  Última Atualização
                </p>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-700 dark:text-slate-50 font-semibold">
            ...
            <div className="flex gap-4">
              <Button variant="ghost" size="sm" asChild>
                <a
                  ...
                  className="text-slate-700 dark:text-slate-100 hover:text-slate-900 dark:hover:text-white transition-colors"
                >
