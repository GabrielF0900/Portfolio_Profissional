...
export default function Footer() {
  ...
  return (
    <footer className="py-12 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-100">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-700 dark:text-slate-50 font-medium">
            ...
            <div className="flex gap-4">
              <Button variant="ghost" size="sm" asChild>
                <a
                  ...
                  className="text-slate-700 dark:text-slate-100 hover:text-slate-900 dark:hover:text-white"
                >
