...
export const projects: PortfolioData = {
  ...
  collaborative: [
    ...
    },
    {
      ...
      description:
        "Nosso Sistema de Gerenciamento de Chamados permite cadastrar usuários com criptografia de ponta a ponta para segurança das senhas e permite resolver problemas a distância graças ao algoritmo de ",
