...
const date = new Date();
const brasiliaDate = new Date(date.toLocaleString('pt-BR', { timeZone: 'America/Sao_Paulo' }));
...
console.log(`✅ Data atualizada para: ${day} de ${monthPT} de ${year}, ${hourFormatted}:${minFormatted}\n`);
...
try {
  ...
  // Faz commit
  console.log('\n📝 Fazendo commit...');
  execSync('git commit -m "chore: update last update timestamp"', { stdio: 'inherit' });
